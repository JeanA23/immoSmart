...
import com.jeananani.immosmart.properties.JwtProperties;
...
public class JwtTokenProvider {
    ...
    /**
     * Methode pour créer le JWT
     * @param userDetails, c'est l'utilisateur connecté
     * @return le JWT de l'utilisateur connecté
     */
