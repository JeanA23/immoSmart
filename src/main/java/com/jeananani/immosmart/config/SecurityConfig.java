...
import com.jeananani.immosmart.security.JwtAccessDeniedHandler;
import com.jeananani.immosmart.security.JwtAuthenticationEntryPoint;
import com.jeananani.immosmart.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws SecurityException {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Endpoints publiques
                        .requestMatchers("/api/v1/immo-smart/auth/**").permitAll()
